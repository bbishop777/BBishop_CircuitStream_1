...
- Keep calm :) I don’t include the controllers package into my pack, because they are generator of problem 
  when unity is updated. Here is the step to do : Include the package controller and drop a character controller
  Into the scene, and next remove the default scene camera.
