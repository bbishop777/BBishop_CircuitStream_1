...
public class VRLocomotion : MonoBehaviour
{
    ...
    void Update()           //Going to handle locomotion here
    {
        ...
        Vector3 playerRight = touchPosition.x * m_director.right;     //determine how much moving to sideways by muliplying how much are director
                                                                      //(controller) is pointing to the right (if pointing to left then x negative
                                                                      //so left movement) by our horizontal speed
        Vector3 playerForward = touchPosition.y * m_director.forward; //determine how much moving forward by multiplying degree of director 
